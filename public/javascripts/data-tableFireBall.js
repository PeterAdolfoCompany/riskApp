...
function dataTableFireBall() {
  ...
  $('#data-tableFireBall tbody').on('click', 'tr', function () {
    ...
    document.getElementById("fbSubstance").value = dataForTntExplosion[table.row(this).index()].name;
    document.getElementById("fbHckjkg").value = dataForTntExplosion[table.row(this).index()].hckjkg;
